...
// // import InProgressTests from "@/components/dashboard/Inprogresstests";
...
//             </div>
//             <span className="text-base font-extrabold tracking-tight text-slate-900">TestStudio</span>
//           </div>
...
//           <div className="flex items-center gap-2">
//             <Link href="/signin" className="hidden rounded-lg px-4 py-2 text-sm font-semibold text-slate-600 transition-colors hover:text-slate-900 sm:block">
//               Login
//             </Link>
//             <Link href="/register" className="rounded-xl bg-gradient-to-r from-sky-400 to-cyan-400 px-4 py-2 text-sm font-bold text-white shadow-sm transition-all hover:opacity-90">
//               Start Free
//             </Link>
